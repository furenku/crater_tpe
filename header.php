...
$is_ecommerce =   in_array(
                     get_page_by_title('Tienda')->ID,
                     get_post_ancestors($post)
                  );

$mostrar_menu_ecommerce = $is_ecommerce || is_page("Catálogo");
         ...
         <main id="principal" class="columns small-12 medium-9 large-10">
            ...
            <header id="cabecera" class="row expanded h_5em" data-sticky-container>
               <div class="sticky w_100 color_blanco_bg z1 h_5em" data-sticky data-anchor="area-stickies" data-margin-top="0">
                  ...
                  <div id="cabecera-titular" class="columns <?php echo $mostrar_menu_ecommerce ? 'medium-5 large-4' : ''; ?>"></div>
                  <?php
                  if( $is_ecommerce || is_page('Catálogo') ) :
                     ?>

                     <nav id="menu-ecommerce" class="columns <?php echo $mostrar_menu_ecommerce ? 'medium-5 large-6 end' : ''; ?> h_5vh color_blanco_bg" data-sticky-container>
